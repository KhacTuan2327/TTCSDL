...
namespace TTCSDL
{
    public partial class DangKy : Form
    {
        ...
        private void btnAddDT_Click(object sender, EventArgs e)
        {
            ...
            {
                GetValuesTextBox();
                string query = "INSERT INTO DETAI VALUES ('" + dt.Madt + "', N'" + dt.Tendt + "', '" + dt.Kinhphi + "', '" + dt.Ngaydangky + "', '" + dt.Nam + "', '" + dt.Tieuban + "', '" + dt.Nganh + "', '" + dt.Capql + "', '" + dt.Chudt + "', N'" + dt.Trangthai + "', N'" + dt.Ketqua + "')";
