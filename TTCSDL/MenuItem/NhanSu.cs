...
namespace TTCSDL
{
    public partial class NhanSu : Form
    {
        ...
        private void NhanSu_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                datanhansu.DataSource = modify.Table("Select MACB as 'Mã cán bộ', TENCB as 'Họ và tên', NGAYSINH as 'Ngày sinh', GIOITINH as 'Giới tính', CAPBAC as 'Cấp bậc', CHUCVU as 'Chức vụ', SĐT as 'Số điện thoại', THOIGIANTHAMGIA as 'Thời gian tham gia', MABM as 'Mã bộ môn' from CANBO");
            }
            catch (Exception ex)
            {
        ...
        private bool CheckTextBoxes()
        {
            ...
            if (txtTGTG.Text == "") { MessageBox.Show("Vui lòng nhập thời gian tham gia!"); return false; }
        ...
        private void GetValuesTextBox()
        {
            ...
            string gt = a;
            Nhansu = new nhansu(id, name, ns, gt, cb, cv, tgtg, sdt, mabm);
        }
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                GetValuesTextBox();
                string query = "INSERT INTO CANBO VALUES (N'" + Nhansu.Id + "', N' " + Nhansu.Name + "',N'" + Nhansu.Ns + "',N'" + Nhansu.Gt + "',N'" + Nhansu.Cb + "',N'" + Nhansu.Cv + "',N'" + Nhansu.Tgtg + "',N'" + Nhansu.Sdt + "',N'" + Nhansu.Mabm + "')";
        ...
        private void datanhansu_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (datanhansu.Rows.Count > 1)
            {
                ...
                txtTGTG.Text = datanhansu.SelectedRows[0].Cells[6].Value.ToString();
                txtPhone.Text = datanhansu.SelectedRows[0].Cells[7].Value.ToString();
                txtmabm.Text = datanhansu.SelectedRows[0].Cells[8].Value.ToString();
            }
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                string choose = datanhansu.SelectedRows[0].Cells[0].Value.ToString();
                string query = "UPDATE CANBO SET TENCB = N'" + Nhansu.Name + " ', NGAYSINH = N'" + Nhansu.Ns + " ', GIOITINH = N' " + Nhansu.Gt + "', CAPBAC = N'" + Nhansu.Cb + "', CHUCVU = N'" + Nhansu.Cv + "',SĐT = N'" + Nhansu.Tgtg + "',THOIGIANTHAMGIA = N'" + Nhansu.Sdt + "',MABM = N'" + Nhansu.Mabm + "'";
