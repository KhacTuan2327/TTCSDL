...
namespace TTCSDL
{
    public partial class ThongKeCHV : Form
    {
        ...
        public string lableSL()
        {
            ...
            cm = new SqlCommand("select count(detai.madt) from  canbo, DETAI, CAPQUANLY where CANBO.MACB = DETAI.MACB and DETAI.MACAP = CAPQUANLY.MACAP and CAPQUANLY.MACAP = N'CHV'", cnn);
        ...
        private void ThongKeCHV_Load(object sender, EventArgs e)
        {
