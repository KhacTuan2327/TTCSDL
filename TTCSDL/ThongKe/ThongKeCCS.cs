...
namespace TTCSDL
{
    public partial class ThongKeCCS : Form
    {
        ...
        public string lableSL()
        {
            ...
            cm = new SqlCommand("select count(detai.madt) from  canbo, DETAI, CAPQUANLY where CANBO.MACB = DETAI.MACB and DETAI.MACAP = CAPQUANLY.MACAP and CAPQUANLY.MACAP = N'CCS'", cnn);
        ...
        private void ThongKeCCS_Load(object sender, EventArgs e)
        {
