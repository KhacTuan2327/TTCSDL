...
namespace TTCSDL
{
    public partial class ThongKeCNN : Form
    {
        ...
        public string lableSL()
        {
            ...
            cm = new SqlCommand("select count(detai.madt) from  canbo, DETAI, CAPQUANLY where CANBO.MACB = DETAI.MACB and DETAI.MACAP = CAPQUANLY.MACAP and CAPQUANLY.MACAP = N'CNN'", cnn);
        ...
        private void ThongKeCNN_Load(object sender, EventArgs e)
        {
